...
public class Sprites
{
	 private String back_shiny_female;
	    ...
	    {
	        return "ClassPojo [back_shiny_female = "+back_shiny_female+", front_shiny_female = "+front_shiny_female+", front_female = "+front_female+", back_shiny = "+back_shiny+", front_shiny = "+front_shiny+", back_female = "+back_female+", back_default = "+back_default+", front_default = "+front_default+"]";
	    }
}
